...
const char* UiTexts::INTERFACE_COUNT = "Total interfaces: %1";
const char* UiTexts::CONNECTIONS_COUNT = "Total connections: %2";
const char* UiTexts::RECIEVED_PACKETS_COUNT = "Recieved packets: %3";
const char* UiTexts::DROPPED_PACKETS_COUNT = "Dropped packets: %4";
const char* UiTexts::PACKETS_DROPPED_INTERFACE = "Packets dropped by the interface: %5";
